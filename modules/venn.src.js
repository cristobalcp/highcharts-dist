...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Venn/VennPoint.js', [_modules['Core/Series/Series.js'], _modules['Mixins/DrawPoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, DrawPointMixin, U) {
        /* *
         *
         *  Imports
         *
    ...
    _registerModule(_modules, 'Series/Venn/VennSeries.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Series/Series.js'], _modules['Core/Color/Color.js'], _modules['Mixins/Geometry.js'], _modules['Mixins/GeometryCircles.js'], _modules['Mixins/NelderMead.js'], _modules['Core/Color/Palette.js'], _modules['Series/Venn/VennPoint.js'], _modules['Series/Venn/VennUtils.js'], _modules['Core/Utilities.js']], function (A, BaseSeries, Color, GeometryMixin, GeometryCirclesModule, NelderMeadMixin, palette, VennPoint, VennUtils, U) {
        /* *
         *
         *  Experimental Highcharts module which enables visualization of a Venn
         *  diagram.
