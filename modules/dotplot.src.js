...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/DotPlot/DotPlotSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Column/ColumnSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, ColumnSeries, U) {
        /* *
         *
         *  (c) 2009-2020 Torstein Honsi
         *
