...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Funnel3DSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Extensions/Math3D.js'], _modules['Core/Utilities.js']], function (BaseSeries, Color, H, Math3D, U) {
        /* *
         *
        ...
        var charts = H.charts,
            _b = H.Renderer.prototype,
            cuboidPath = _b.cuboidPath,
            elements3d = _b.elements3d;
