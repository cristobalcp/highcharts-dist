...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Wordcloud/WordcloudPoint.js', [_modules['Mixins/DrawPoint.js'], _modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (DrawPointMixin, BaseSeries, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/Wordcloud/WordcloudSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Globals.js'], _modules['Series/Line/LineSeries.js'], _modules['Mixins/Polygon.js'], _modules['Core/Utilities.js'], _modules['Series/Wordcloud/WordcloudPoint.js'], _modules['Series/Wordcloud/WordcloudUtils.js']], function (BaseSeries, H, LineSeries, PolygonMixin, U, WordcloudPoint, WordcloudUtils) {
        /* *
         *
         *  Experimental Highcharts module which enables visualization of a word cloud.
         *
