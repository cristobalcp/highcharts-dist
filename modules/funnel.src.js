...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Funnel/FunnelSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Color/Palette.js'], _modules['Core/Utilities.js']], function (BaseSeries, Chart, H, palette, U) {
        /* *
         *
         *  Highcharts funnel module
         *
    ...
    _registerModule(_modules, 'Series/Pyramid/PyramidSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Funnel/FunnelSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, FunnelSeries, U) {
        /* *
         *
         *  Highcharts funnel module
         *
