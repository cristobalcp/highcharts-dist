...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Sankey/SankeyPoint.js', [_modules['Core/Series/Series.js'], _modules['Mixins/Nodes.js'], _modules['Core/Series/Point.js'], _modules['Core/Utilities.js']], function (BaseSeries, NodesMixin, Point, U) {
        /* *
         *
         *  Sankey diagram module
         *
    ...
    _registerModule(_modules, 'Series/Sankey/SankeySeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Mixins/Nodes.js'], _modules['Series/Sankey/SankeyPoint.js'], _modules['Mixins/TreeSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, Color, H, NodesMixin, SankeyPoint, TreeSeriesMixin, U) {
        /* *
         *
         *  Sankey diagram module
         *
